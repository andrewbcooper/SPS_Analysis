  ...
  sidebarLayout(
    sidebarPanel(
      ...
      h5("This tool compares the proposed SPS start times to data from US Census Bureau's 2016-2020 American Community Survey (ACS) on the percent of households departing for work by certain times
         and to student demographic data from the Washington Office of Superintendent  of Public Instruction's (OSPI). The impact of the propsed start times are measured in two ways: 
